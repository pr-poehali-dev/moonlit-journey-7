...
const films: Film[] = [
  ...
  { id: 3,  title: "Форма жизни",     author: "Айрат Башаров",         synopsis: "У юной девушки есть мечта: купить себе музыкальный инструмент своими силами. Но один курьёзный случай мешает её планам. Как она справится с этим — или ей кто-то поможет?",  duration: "—",     location: "Банк / банкомат",      block: 2, x: 77, y: 36, image: "https://cdn.poehali.dev/projects/59266136-7b6c-414f-a200-d1fd1000076c/bucket/9fc2d1f2-f2ff-49db-ab8f-6923267b1984.png" },
      ...
      <div className="bg-zinc-900/95 border border-red-500/30 rounded-lg p-4 shadow-2xl backdrop-blur">
        ...
        {film.image && (
          <div className="mb-3 rounded overflow-hidden">
            <img src={film.image} alt={film.title} className="w-full h-32 object-cover object-top" />
          </div>
        )}
