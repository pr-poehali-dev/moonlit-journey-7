...
const films: Film[] = [
  ...
  { id: 3,  title: "Форма жизни",     author: "Айрат Башаров",         synopsis: "У юной девушки есть мечта: купить себе музыкальный инструмент своими силами. Но один курьёзный случай мешает её планам. Как она справится с этим — или ей кто-то поможет?",  duration: "—",     location: "Банк / банкомат",      block: 2, x: 77, y: 36, image: "https://cdn.poehali.dev/projects/59266136-7b6c-414f-a200-d1fd1000076c/bucket/85d3f854-e1ff-44bd-9597-0ccccfa65443.png" },
