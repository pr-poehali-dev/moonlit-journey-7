...
const films: Film[] = [
  ...
  { id: 9,  title: "С любовью, Борис",author: "Виталий Красильников",  synopsis: "«Не читал, но осуждаю» — последствия травли великого поэта Пастернака Бориса в вольной интерпретации Красильникова Виталия.",  duration: "15:07", location: "Деревенский домик",    block: 1, x: 14, y: 72 },
  { id: 15, title: "ПВЗ",             author: "Артур Камалов",         synopsis: "Мрачная фантастическая драма о нарастающем безумии вокруг рядового оператора нишевого пункта выдачи заказов на фоне мирового кризиса.",  duration: "9:45",  location: "ПВЗ",                  block: 1, x: 41, y: 55 },
  ...
  { id: 21, title: "Plato",           author: "Темур Сангинов",        synopsis: "Экспериментальный фильм, приглашающий зрителя поучаствовать в интерпретации истории о расставании, принятии и столкновении с очередной непреодолимой стеной. Так ли это на самом деле?",  duration: "6:13",  location: "Роллердром/скейтпарк", block: 1, x: 36, y: 83 },
