...
const faqs = [
  ...
  { q: "Что будет после показа?", a: "После каждого сеанса — открытое обсуждение с авторами фильмов. Можно задать вопросы, поговорить о кино и познакомиться с командой." },
