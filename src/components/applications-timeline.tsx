    ...
    shows: [
      {
        ...
        sessions: [
          ...
          },
          {
            time: "14:00",
            title: "Дневной показ",
            desc: "Полная программа фестиваля. Показ для тех, кто предпочитает дневное время.",
            type: "screening",
          },
          {
            time: "после показа",
      ...
      },
      {
        ...
        sessions: [
          ...
          },
          {
            ...
            desc: "Полная программа фестиваля. Основной вечерний сеанс.",
            type: "screening",
          },
          {
            time: "после показа",
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mt-10 text-center">
          <p className="font-geist text-white/25 text-xs mb-5">
            * Расписание может измениться. Следите за обновлениями в соцсетях пространства «ОКИНО» и на сайте.
          </p>
